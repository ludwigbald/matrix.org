...
const TryNow = () => {
    return (<Layout hasNavPadding="true">
            ...
            <div class="mxblock mxblock--try">
                ...
                <p class="mxblock--try__p">The easiest way to try Matrix is to use the <a href="https://riot.im/app/" rel="noopener noreferrer" target="_blank">Riot Web</a> client in your browser, which is configured by default to connect to the matrix.org homeserver.</p>
                
                <a href="https://riot.im/app/" rel="noopener noreferrer" target="_blank">
